...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('threadedcomments_comment', (
            ...
            ('tree_path', self.gf('django.db.models.fields.TextField')(db_index=True, max_length=255)),
        ))
    ...
    models = {
        ...
        'threadedcomments.threadedcomment': {
            ...
            'tree_path': ('django.db.models.fields.TextField', [], {'db_index': 'True', 'max_length': '255'})
        }
    }
