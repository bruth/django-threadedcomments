...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ThreadedComment.rank'
        db.add_column('threadedcomments_comment', 'rank', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ThreadedComment.rank'
        db.delete_column('threadedcomments_comment', 'rank')
    ...
    models = {
        ...
        'threadedcomments.threadedcomment': {
            'Meta': {'ordering': "('tree_path', 'rank')", 'object_name': 'ThreadedComment', 'db_table': "'threadedcomments_comment'", '_ormbases': ['comments.Comment']},
